...
public class GammaDoubleRef_loadTest implements GammaConstants {

    private GammaStm stm;
    private boolean readBiased;
    private boolean arriveNeeded;

    public GammaDoubleRef_loadTest(boolean readBiased, boolean arriveNeeded) {
    ...
    public GammaDoubleRef newLongRef(double initialValue) {
    ...
    public void locking_whenNotLockedByOtherAndNoLockNeeded() {
        ...
        GammaDoubleRef ref = newLongRef(initialValue);
        ...
        assertEqualsDouble(initialValue, longAsDouble(tranlocal.long_value));
        assertEqualsDouble(initialValue, longAsDouble(tranlocal.long_oldValue));
