...
public class GammaTxnDouble extends BaseGammaTxnRef implements TxnDouble {
    ...
    public GammaTxnDouble(final GammaTxn tx) {
        this(tx, 0);
    }
    ...
    public GammaTxnDouble(final GammaStm stm) {
        this(stm, 0);
    }

    public GammaTxnDouble(final GammaStm stm, final double value) {
    ...
    public final String toDebugString() {
        return String.format("GammaTxnDouble{orec=%s, version=%s, value=%s, hasListeners=%s)",
