...
public interface Ref<E> extends TransactionalObject {
     ...
     *                  is guaranteed to have been aborted.
     */
    E getAndLock(Transaction txn, LockMode lockMode);
    ...
    *                  is guaranteed to have been aborted.
    */
    E setAndLock(Transaction txn, E value, LockMode lockMode);
     ...
     *                  is guaranteed to have been aborted.
     */
    E getAndSet(Transaction txn, E value);
     ...
     *                  is guaranteed to have been aborted.
     */
    E getAndSetAndLock(Transaction txn, E value, LockMode lockMode);
     ...
     *                  is guaranteed to have been aborted.
     */
    void commute(Transaction txn,Function<E> function);
     ...
     *                  is guaranteed to have been aborted.
     */
    E alterAndGet(Transaction txn,Function<E> function);
     ...
     *                  is guaranteed to have been aborted.
     */
    E getAndAlter(Transaction txn, Function<E> function);
     ...
     *                  is guaranteed to have been aborted.
     */
    boolean isNull(Transaction txn);
     ...
     *                  is guaranteed to have been aborted.
     */
    E awaitNotNullAndGet(Transaction txn);
    ...
    * @throws org.multiverse.api.exceptions.TransactionExecutionException
     ...
     *                  is guaranteed to have been aborted.
    */
    void awaitNull(Transaction txn);
     ...
     *                  is guaranteed to have been aborted.
     */
    void await(Transaction txn,E value);
     ...
     *                  is guaranteed to have been aborted.
     */
    void await(Transaction txn, Predicate<E> predicate);
}
