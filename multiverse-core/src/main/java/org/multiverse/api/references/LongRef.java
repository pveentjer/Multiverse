...
public interface LongRef extends TransactionalObject {
     ...
     *                  is guaranteed to have been aborted.
     */
    long getAndLock(Transaction txn, LockMode lockMode);
    ...
    *                  is guaranteed to have been aborted.
    */
    long set(Transaction txn, long value);
    ...
    *                  is guaranteed to have been aborted.
    */
    long setAndLock(Transaction txn, long value, LockMode lockMode);
     ...
     *                  is guaranteed to have been aborted.
     */
    long getAndSet(Transaction txn, long value);
     ...
     *                  is guaranteed to have been aborted.
     */
    long getAndSetAndLock(Transaction txn, long value, LockMode lockMode);
     ...
     *                  is guaranteed to have been aborted.
     */
    void commute(Transaction txn,LongFunction function);
     ...
     *                  is guaranteed to have been aborted.
     */
    long alterAndGet(Transaction txn,LongFunction function);
     ...
     *                  is guaranteed to have been aborted.
     */
    long getAndAlter(Transaction txn, LongFunction function);
     ...
     *                  is guaranteed to have been aborted.
     */
    long getAndIncrement(Transaction txn, long amount);
     ...
     *                  is guaranteed to have been aborted.
     */
    long incrementAndGet(Transaction txn, long amount);
     ...
     *                  is guaranteed to have been aborted.
     */
    void increment(Transaction txn, long amount);
     ...
     *                  is guaranteed to have been aborted.
     */
    void decrement(Transaction txn, long amount);
     ...
     *                  is guaranteed to have been aborted.
     */
    void await(Transaction txn,long value);
     ...
     *                  is guaranteed to have been aborted.
     */
    void await(Transaction txn, LongPredicate predicate);
}
